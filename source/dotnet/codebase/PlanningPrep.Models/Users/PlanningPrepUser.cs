...
namespace PlanningPrep.Models.Users
{
    ...
    public class PlanningPrepUser : BaseEntity
    {
        ...
        /// <returns></returns>
        public static PlanningPrepUser CreateBaseUserFromDataReader(IDataReader reader)
        {
            PlanningPrepUser user = EntityFactory.Create<PlanningPrepUser>();
        ...
        /// <param name="reader">The reader.</param>
        /// <returns></returns>
        public static PlanningPrepUser CreateFromDataReader(IDataReader reader)
        {
            PlanningPrepUser user = EntityFactory.Create<PlanningPrepUser>();
