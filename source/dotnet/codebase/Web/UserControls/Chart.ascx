...
<div style="border:#000000 1px solid; width:222px; height:197px;">
    <table style="border-style:solid; border-collapse: collapse; width:222px; height:197px; background-image:url(/Images/chartback.gif);">
        <tr>
