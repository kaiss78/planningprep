<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="JoinOutcome.aspx.cs" Inherits="Pages_Public_JoinOutcome" Title="Untitled Page" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <script language="javascript" type="text/javascript">
        ...
        function ShowCheck()
        {
            $('#divPayByCheckContainer').fadeIn();
        }
         function ShowSubmitPayment()
        {
            $('#divMainContainer').fadeIn();
        }
    </script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    <div id="divMainContainer">
        ...
        <div style="float:left; width:48%">
            ...
            <div style="margin-top:20px;">
                ...
                <a href="javascript:void(0);" onclick="TogglePaybyCheck();">
                    <img border="0" src="/Images/bycheck.gif" alt="Pay By Check" title="Pay By Check" />
                </a>
            </div>    
        </div>
    ...
    <div id="divPayByCheckContainer" style="display:none;">
        <div class="contentheading">Payment By Check</div>  
        <div>
            You have chosen to process your account by check. Accounts processed 
	        by check are activated upon receipt of the check. If the check does 
	        not clear, the account will be disabled.
        </div>
        <div class="contentsubheading">Payment Instructions</div>
        <div>
            <b>Checks must be for the amount of $120.00 USD. Checks must be made payable to:</b>
            <div style="margin-top:15px;">
                Houseal Lavigne Associates<br />
                114 E Van Buren Ave<br />
                Naperville, IL 60540
            </div>
            <div style="margin-top:15px; margin-bottom:15px;">
                If you have any additional questions, please <a href="/Pages/Public/ContactUs.aspx">contact us</a>.
            </div>
            <div><a href="javascript:void(0);" onclick="TogglePaybyCheck();">Back to Submit Payment</a></div>
        </div>
    </div>
</asp:Content>
