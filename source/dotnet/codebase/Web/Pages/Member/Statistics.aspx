<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true"
    CodeFile="Statistics.aspx.cs" Inherits="Pages_Member_Statistics" Title="Untitled Page" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" runat="Server">
    <div class="contentheading" id="divHeading" runat="server">
        Your Statistics Since Joining</div>
    <%--Left Containter--%>
    <%--Filter Controls with Calendar Containr--%>
    <div>
        Use the tool below to view your statistics from a specific date forward. This is
        a great way to see what kind of progress you have been making. Select a date below
        and press Filter.
    </div>
    <asp:Panel ID="pnlFilterBox" CssClass="calendarcontainer" runat="server" DefaultButton="btnFilter">
        <div class="floatleft">
            Start Date
            <asp:TextBox ID="txtStartDate" CssClass="TextBoxCommon calendarInput" runat="server"
                MaxLength="30"></asp:TextBox>
        </div>
        <div class="floatleft" style="margin-left: 15px;">
            End Date
            <asp:TextBox ID="txtEndDate" CssClass="TextBoxCommon calendarInput" runat="server"
                MaxLength="30"></asp:TextBox>
        </div>
        <div class="floatleft" style="margin-left: 15px;">
            <asp:Button ID="btnFilter" runat="server" Text="Filter" CssClass="ButtonCommon" ValidationGroup="Filter"
                OnClick="btnFilter_Click" Style="width: 70px;" />
        </div>
        <div class="floatleft" style="margin-left: 15px;">
            <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" ControlToValidate="txtStartDate"
                Display="Dynamic" ErrorMessage="Please select a Start Date." ValidationGroup="Filter">
            ...
            <asp:CompareValidator ID="cvStartDate" runat="server" ControlToValidate="txtStartDate"
                Display="Dynamic" Type="Date" Operator="DataTypeCheck" ErrorMessage="Please select a valid Start Date."
                ValidationGroup="Filter">
            </asp:CompareValidator>
            <asp:CompareValidator ID="cvEndDate" runat="server" ControlToValidate="txtEndDate"
                Display="Dynamic" Type="Date" Operator="DataTypeCheck" ErrorMessage="Please select a valid End Date."
                ValidationGroup="Filter">
            </asp:CompareValidator>
            <asp:CompareValidator ID="cvDateRange" runat="server" ControlToValidate="txtEndDate"
                ControlToCompare="txtStartDate" Display="Dynamic" Type="Date" Operator="GreaterThanEqual"
    ...
    <div class="homepagecontentbox" style="width: 300px;">
        <div style="margin-bottom: 15px;">
            <b>Statistics By Category</b></div>
        <div id="divCategoryContainer" runat="server">
        </div>
    </div>
