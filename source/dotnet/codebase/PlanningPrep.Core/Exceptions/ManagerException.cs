 ...
 * Purpose: Custom exception class for ServiceException
 *                   
 * Author: MH
...
{
    public class ManagerException : PanthException
    {        
        /// <summary>
        ...
        public ManagerException(string errorMessage, Exception innerException)
        ...
        public ManagerException(string errorMessage, Exception innerException,string exceptionSource)
