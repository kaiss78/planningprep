...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentBody" Runat="Server">
    ...
    <div>
        ...
        If you are already a member please sign in. If you are interested in becoming a member, 
        please visit the <a href="<%=AppConstants.Pages.REGISTER%>">join now</a> page. If you have forgotten your login information, 
        <a href="<%=AppConstants.Pages.FORGOT_PASSWORD %>">click here</a>.
    </div>
